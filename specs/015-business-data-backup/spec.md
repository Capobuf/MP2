...
1. **Given** un workbook V1 o V2 valido, **When** il Platform Admin lo carica, **Then** vede Azienda sorgente, data, formato, Esercizi, conteggi, totali, allegati non ripristinabili e warning sul nome duplicato.
...
- **FR-BDB-011**: Ogni versione MUST definire e mantenere stabili prefissi e ordinamento dei riferimenti portabili per Azienda, Esercizi, anagrafiche, Progetti, Contratti, Spese, Righe, transizioni, condizioni, lifecycle, classificazioni, rinvii, Budget, Chiusure, correzioni, annotazioni e allegati inventariati.
...
- **FR-BDB-013**: Azienda, impostazioni, Fornitori, contatti, Centri di Costo, gerarchia opzionale e stati Archivio MUST essere preservati integralmente nei loro dati business.
...
- **FR-BDB-052**: Le lineage materializzate nei payload Budget e Chiusura V2 MUST essere convertite in riferimenti portabili e reidratate con i nuovi ID senza usare la gerarchia viva.
...
- Non è definito un limite business massimo di record; il formato privilegia correttezza e artefatto coerente, con verifica su dataset rappresentativi del prodotto corrente.
